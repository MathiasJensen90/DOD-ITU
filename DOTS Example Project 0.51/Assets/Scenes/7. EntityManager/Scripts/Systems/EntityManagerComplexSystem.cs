...
//                 if (managerSingleton.hasBuffer) Debug.Log("Buffer length: " + GetBuffer<ListOfEntitiesCreatedComponent>(entity).Length);
//             }
...
//                     var buffer = GetBuffer<ListOfEntitiesCreatedComponent>(entity);
...
//                 if (managerSingleton.hasBuffer)
//                 {
//                     var lengthOffBuffer = GetBuffer<ListOfEntitiesCreatedComponent>(entity).Length - 1;
//                     if (lengthOffBuffer >= 0)
//                     {
//                         EntityManager.DestroyEntity(GetBuffer<ListOfEntitiesCreatedComponent>(entity)[lengthOffBuffer]
//                             .entity);
//                         GetBuffer<ListOfEntitiesCreatedComponent>(entity).RemoveAt(lengthOffBuffer);
//                     }
//                     else
//                     {
...
//             {
//                 if (managerSingleton.hasBuffer && GetBuffer<ListOfEntitiesCreatedComponent>(entity).Length != 0)
//                 {
//                     var buffer = GetBuffer<ListOfEntitiesCreatedComponent>(entity);
//                     int lengthOffBuffer = buffer.Length - 1;
//              
//                         var localEntity = buffer[lengthOffBuffer].entity; 
//                         if (!HasComponent<NonUniformScale>(localEntity))
//                         {
...
//                         else
//                         {
//                             var currentScale = GetComponent<NonUniformScale>(localEntity).Value;
...
//                 EntityManager.AddComponentData(e, new CharactherStats
//                 {
//                     damage = 1,
//                     health = 10,
//                     coldownTime = 1
